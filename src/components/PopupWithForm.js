...
function PopupWithForm({ name, isOpen, formConfirm, text, buttonName, children, onSubmit, onClose, isDisabled }) {
    ...
    <div className={`popup popup_type_${name} ${isOpen ? 'popup_opened' : ''}`} id={`popup__${name}`}>
      <div className="popup__container">
        ...
        <div className="form">
          ...
          <form noValidate onSubmit={onSubmit} className="form__container" name={`popup__${name}`}>
            {children}
            <button
